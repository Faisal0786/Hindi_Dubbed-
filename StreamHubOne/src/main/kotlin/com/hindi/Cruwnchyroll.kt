    ...
    runAllAsync(
        ...
        // Anime/MALSync sources
        {
            if (res.isAnime) {
                ...
                // Agar AniList/MAL ID already available hai
                ...
                // Existing IDs nahi mile to IMDb mapping bhi parallel source
                // ke roop me try karo — fallback nahi.
                val imdbResult = runCatching {
                    convertImdbToAnimeId(
                        res.title,
                        year,
                        res.firstAired,
                        if (res.tvtype == "movie")
                ...
                // TMDB mapping bhi independently try karo
