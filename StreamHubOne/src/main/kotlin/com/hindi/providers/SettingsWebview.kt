...
fun showNetMirror(context: Context, onCookiesChanged: () -> Unit = {}) {
    val theme = SettingsTheme
    val mainHandler = Handler(Looper.getMainLooper())

    val targetUrl = "https://netmirror.gg"
    var currentUrl = targetUrl
    var dialogRef: Dialog? = null
    ...
    val webView = WebView(context).apply {
        ...
        webViewClient = object : WebViewClient() {
            ...
            override fun onPageStarted(
                ...
                val savedCookie =
                    Settings.getCookieForDomain(url)
    ...
    val titleBar = LinearLayout(context).apply {
        ...
        background =
            theme.colorDrawable(theme.BG_CARD)
    ...
    val root = LinearLayout(context).apply {
        ...
        background =
            theme.colorDrawable(theme.BG_DARK)
    ...
    /*
     * Load saved NetMirror cookies before opening the page.
     */
    val savedCookie =
        Settings.getCookieForDomain(targetUrl)
    ...
    if (!savedCookie.isNullOrBlank()) {
        ...
        Log.d(
            "NetMirrorWebView",
            "Preloaded saved NetMirror cookies"
        )
    }
