...
2. Go to the **Extensions** tab from the bottom navigation menu.
3. Tap on the **Add Repository** (or plus) button.
4. Paste your repository JSON URL.
5. Tap **Add** and install the desired extensions.

## Available Extensions

| Extension Name | Type | Status | Description |
| :--- | :--- | :--- | :--- |
| **Provider 1** | Movies / TV | Working | High-quality links and multi-language support. |
| **Provider 2** | Anime | Working | Subbed and dubbed anime streaming. |
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/Faisal0786/Hindi_Dubbed-.git](https://github.com/Faisal0786/Hindi_Dubbed-.git)
